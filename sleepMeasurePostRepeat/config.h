...
#ifdef ESP32 //ESP32
#define NBITS (12)
//NOTE: ADCVREF should be measured with a multimeter for better accuracy, default is 1.1 V
#define ADCVREF (1.1)//[V] //NOTE: for 0 db attenuation (0 - 1.1 V input range)
//correct the ADC values using the look-up table calibration
//#define ADCCALIBRATION //NOTE: this is different for each ESP32
#else //ESP8266
#define NBITS (10)
...
#define ADC0RDIV (84.5e3) //ADC voltage divider resistor value [Ohm] //84.5e3
